...
export function NotificationsDetailScreen({
  ...
  if (!item) {
    return (
      <OnboardingLayout variant="onboardingBlue" contentInset={layout.contentPadSettingsDetail} scrollable>
  ...
  return (
    <OnboardingLayout variant="onboardingBlue" contentInset={[6, 20, 18, 20]} scrollable>
