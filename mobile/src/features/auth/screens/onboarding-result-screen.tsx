...
export function OnboardingResultScreen({ navigation }: AuthStackScreenProps<"OnboardingResult">): ReactElement {
  ...
  return (
    <OnboardingLayout variant="result" contentInset={layout.contentPadResult} scrollable>
