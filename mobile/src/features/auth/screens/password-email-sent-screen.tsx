...
type PasswordEmailSentRouteProp = {
  ...
  params: AuthStackParamList["PasswordEmailSent"];
};
...
export function PasswordEmailSentScreen({
  navigation,
}: AuthStackScreenProps<"PasswordEmailSent">): ReactElement {
  ...
  return (
    <OnboardingLayout variant="auth" contentInset={layout.contentPadAuth} scrollable>
