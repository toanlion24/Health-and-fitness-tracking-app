...
import { countUnreadNotifications, useNotificationsHubStore } from "../../settings/store/notifications-hub-store";
...
import { useNutritionApiStore, getTodayTotals } from "../../nutrition/store/nutrition-api-store";
import { useProgressDashboardStore } from "../../metrics/store/progress-dashboard-store";
import { useWorkoutStore } from "../../workouts/store/workout-store";
...
export function HomeDashboardScreen({ navigation }: HomeDashboardCompositeProps): ReactElement {
  ...
  return (
    <View style={{ flex: 1 }}>
    <OnboardingLayout variant="coachPulse" statusBarLight contentInset={layout.contentPadHome} scrollable>
