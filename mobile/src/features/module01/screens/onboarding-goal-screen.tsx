...
export function OnboardingGoalScreen({ navigation }: Module01StackScreenProps<"OnboardingGoal">): ReactElement {
  const goal = useModule01Store((s) => s.goal);
  const setGoal = useModule01Store((s) => s.setGoal);

  return (
    <Module01Layout variant="onboardingCyan">
